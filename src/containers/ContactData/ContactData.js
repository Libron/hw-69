...
class ContactData extends Component {
  ...
  orderHandler = event => {
    ...
    // Чтобы убедится что заказ оформлен вы можете посмотреть на firebase - редирект:
    window.location.replace('https://blog-lab63.firebaseio.com/orders.json?print=pretty');
  };
